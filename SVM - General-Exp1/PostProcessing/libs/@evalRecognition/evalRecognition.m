classdef evalRecognition
    ...
    methods
        ...
        function obj = evalRecognition(repInfo,response,evalOptions)
            ...
            %fprintf('Gesto Real: %-10s | Gesto Predicho: %-10s\n', string(trueClass), string(classPrediction));
            ...
            fprintf("Gesto real: %s, Gesto predicho: %s, Son iguales: %s\n", ...
            string(trueClass), string(classPrediction), string(obj.classResult));
